...
//
//struct Supermarket: Identifiable, Codable, Equatable, Hashable {
//    var id: String // 使用 place_id 作為 id
//    var name: String
//    var address: String
//    var coordinate: CLLocationCoordinate2D
//
//    enum CodingKeys: String, CodingKey {
//        case id = "place_id" // 映射 place_id
//        case name, address, latitude = "lat", longitude = "lng"
//    }
//
//    // 自定义解码以支持 CLLocationCoordinate2D
//    init(from decoder: Decoder) throws {
...
//
//struct PlaceResult: Decodable {
//    let place_id: String // 添加 place_id
//    let name: String
//    let vicinity: String
//    let geometry: Geometry
//}
...
//    @Published var supermarkets = [Supermarket]()
//    private let savedSupermarketsKey = "savedSupermarkets"
//    private let apiKey = "AIzaSyBb_LtEBzE0y2mATvrQ3sZnaWnieTHf6_E" // 替換為你的 API Key
//
//    // 儲存上次 API 請求的位置和超市數據
//    private var lastFetchedLocation: CLLocation?
//    private var cacheDuration: TimeInterval = 60 * 60 // 1小時的緩存時間
...
//                        let newSupermarkets = decodedResponse.results.map { result in
//                            Supermarket(
//                                id: result.place_id, // 使用 place_id 作為 id
//                                name: result.name,
//                                address: result.vicinity,
//                                coordinate: CLLocationCoordinate2D(
//                                    latitude: result.geometry.location.lat,
